  ...
  actions: {
    login(userInfo: UserInfo) {
      ...
      return new Promise((resolve, reject) => {
        Http.postRequest<Response>('/vue-element-admin/user/login', { username: username.trim(), password: password })
    ...
    getInfo(): Promise<UserInfoResponse> {
      return new Promise((resolve, reject) => {
        Http.getRequest<Response>('/vue-element-admin/user/info', { params: { token: this.token } })
          .then((response: Response<UserInfoResponse>) => {
            const { data } = response
