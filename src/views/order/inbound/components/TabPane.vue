    ...
    >
      <template #table>
        ...
        >
          ...
          >
            <template #default="{ row }">
              {{ typeMap[(row as InboundData).type] }}
            </template>
          </el-table-column>
          ...
          >
            <template #default="{ row }">
              <el-tag :type="statusMap[(row as InboundData).status].type">
                {{ statusMap[(row as InboundData).status].label }}
              </el-tag>
            </template>
          </el-table-column>
